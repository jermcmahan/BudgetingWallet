...
//
#ifndef  _fixed_pt_h_   // Avoid double includes
#define  _fixed_pt_h_   // Prevent double include
...
namespace fixed_pt_space {
    ...
    public:
        ...
        fixed_pt(const int number){
            value = number * fixed_exp;
        }
        ...
        bool operator >(const fixed_pt& other){
